...
export default function AddEmployee() {
  ...
  async function onSubmit(data) {
    try {
      ...
      if (res.ok) { toast.success('Employee added!'); nav('/admin/employees', { replace: true }); }
  ...
  return (
    <div className="hrms-content">
      <div className="page-header">
        <h4><i className="bi bi-person-plus"></i> Add Employee</h4>
      </div>
        ...
        <form onSubmit={handleSubmit(onSubmit)} noValidate>
          <div className="row g-3">
            ...
            <div className="col-md-6">
              ...
              <input type="password" className={`form-control ${errors.passwordHash ? 'is-invalid' : ''}`}
                placeholder="Password"
                {...register('passwordHash', { required: 'Password is required' })} />
              <div style={{ minHeight: 20 }}>
                {errors.passwordHash && <div className="invalid-feedback d-block">{errors.passwordHash.message}</div>}
              </div>
            </div>
            ...
            <div className="col-12">
              ...
              <textarea className="form-control" rows={2} placeholder="Address" {...register('address')} />
              <div style={{ minHeight: 20 }}></div>
            </div>
            ...
            <div className="col-md-6">
              <label className="form-label">Manager <small className="text-muted">(select department first)</small></label>
          ...
          <div className="d-flex gap-2 mt-3">
            <button className="btn btn-primary px-4">Add Employee</button>
